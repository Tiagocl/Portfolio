...
const Hero = () => {
  ...
  return (
    <div className='relative z-20 flex justify-center items-center w-full h-80 transform translate-y-[20vh] '>
    <div className="flex flex-col w-[50%] h-80 justify-start gap-10 pl-22">
      ...
      <div className="text-[#9CA3AF] text-lg w-[90%] tracking-wide">
        <span class>Good design is more than just pixels, it's an <span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-500
          to-cyan-500'>experience.</span></span>
        <br />
        <span>Let's create something special together. Checkout my projects and skills.</span>
    ...
    <div className="flex justify-center items-center w-[50%] h-80 ">
      Nao sei o que por aqui ainda
    </div>
    </div>
  );
};
