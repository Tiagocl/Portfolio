    ...
    <div className='relative h-[80vh]  w-screen overflow-hidden'>
      ...
      <div className='h-full w-[90%] flex flex-col justify-start items-center m-auto mt-24 text-[#e5e7eb] text-[50px] gap-10'>
        ...
        <div className='flex flex-col justify-start items-center gap-5'>
          ...
          <PurpleTag text="The person behind the code" width="220" />
          <span className='text-[#E5E7EB]  text-xl tracking-wide italic'>"Mastery is a journey, not a destination."</span>
        </div>
        <div className='flex justify-center items-start h-full w-full '>
          ...
          <div className="grid grid-cols-3 grid-rows-3 gap-10 w-1/2 max-w-md mx-auto text-white text-center font-bold">
            ...
            <TechIcon Icon={GrMysql} color="" label="MySQL" />
            <TechIcon Icon={FaGitAlt} color="#E14E1D" label="Git" />
            <TechIcon Icon={FaPhp} color="#4F5B93" label="PHP" />
          </div>
        </div>
      </div>
    </div>
